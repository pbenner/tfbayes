...
void test_tree1() {
        ...
        polynomial_t<alphabet_size, code_t> result = pt_expand<alphabet_size, code_t>(incomplete_expression, observations);
...
void test_tree6() {
        ...
        for (incomplete_expression_t::const_iterator it = incomplete_expression.begin(); it != incomplete_expression.end(); it++) {
                cout << *it << ": "
                     << pt_expand<alphabet_size, code_t>(*it, observations) << endl;
        }
}
