...
void test_tree1() {
        ...
        polynomial_t<code_t, alphabet_size> result = pt_expand<code_t, alphabet_size>(incomplete_expression, observations);
...
void test_tree6() {
        ...
        for (incomplete_expression_t::const_iterator it = incomplete_expression.begin(); it != incomplete_expression.end(); it++) {
                cout << *it << ": "
                     << pt_expand<code_t, alphabet_size>(*it, observations) << endl;
        }
}
