...
void test_tree1(const exponent_t<alphabet_size> alpha) {
        cout << "Test 1:" << endl;
...
void test_tree2(const exponent_t<alphabet_size> alpha) {
        cout << "Test 2:" << endl;
        pt_leaf_t* n2 = new pt_leaf_t(1.0, "n2");
        pt_leaf_t* n3 = new pt_leaf_t(2.0, "n3");
        pt_root_t n1(n2, n3);
...
void test_tree3(const exponent_t<alphabet_size> alpha) {
        cout << "Test 3:" << endl;
...
void test_tree4(const exponent_t<alphabet_size> alpha) {
        cout << "Test 4:" << endl;
...
void test_tree5(const exponent_t<alphabet_size> alpha) {
        cout << "Test 5:" << endl;
        pt_leaf_t* n7 = new pt_leaf_t(2.0, "n7");
        pt_leaf_t* n6 = new pt_leaf_t(1.0, "n6");
        pt_leaf_t* n5 = new pt_leaf_t(2.0, "n5");
...
void test_tree6(const exponent_t<alphabet_size> alpha) {
        cout << "Test 6:" << endl;
