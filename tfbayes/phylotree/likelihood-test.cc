...
void test_tree1() {
        ...
        polynomial_t<alphabet_size, code_t> result = pt_polynomial<alphabet_size, code_t>(n1, observations);
        cout << result << endl
...
void test_tree7() {
        ...
        polynomial_t<alphabet_size, code_t> result1 = pt_polynomial<alphabet_size, code_t>(n1, observations1);
        polynomial_t<alphabet_size, code_t> result2 = pt_polynomial<alphabet_size, code_t>(m1, observations2);
...
void test_tree10() {
        ...
        polynomial_t<alphabet_size, code_t> result = pt_polynomial<alphabet_size, code_t>(n2, observations);
        cout << result << endl
             << "0.839524 Pc^3 Pg^1 + 0.000950355 Pc^1 Pg^1 + 0.0450738 Pc^2 Pg^1 (correct polynomial)"
             << endl << endl;
}
...
void test_tree11() {
        ...
        polynomial_t<alphabet_size, code_t> result = pt_polynomial<alphabet_size, code_t>(n7, observations);
        cout << result << endl
