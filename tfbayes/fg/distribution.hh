...
public:
        ...
        virtual double density(const vector_t& x) const = 0;
        ...
        virtual vector_t statistics(double x) const = 0;
...
public:
        ...
        virtual vector_t statistics(double x) const {
                return statistics(vector_t(1, x));
        }
        virtual vector_t statistics(const vector_t& x) const = 0;
        virtual double density(const vector_t& x) const {
